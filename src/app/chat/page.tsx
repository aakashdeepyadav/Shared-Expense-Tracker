...
import { subscribeToMessages, addMessage, markMessagesAsRead } from "@/lib/firestore";
        ...
        <div className="flex-1 flex flex-col w-full max-w-4xl mx-auto">
            <div className="flex-1 overflow-y-auto space-y-6 pr-2">
                ...
                return (
                    ...
                    <div
                        className={cn(
                        "max-w-[75%] md:max-w-[70%] p-3 rounded-lg flex flex-col",
                        isOwnMessage
                    ...
                    >
                        ...
                        {!isOwnMessage && <span className="font-bold text-sm">{msg.userName}</span>}
